  ...
  _createClass(EZModal, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          reOpen = _props.reOpen,
          otherProps = _objectWithoutProperties(_props, ['data', 'trigger', 'header', 'content', 'actions', 'handleRemove', 'removeHeader', 'removeContent', 'noCloseButton', 'noSubmitButton', 'closeButtonText', 'submitButtonText', 'disableHiddenSubmitButton', 'handleSubmit', 'loading', 'error', 'errorHeader', 'initiallyOpen', 'onClose', 'reOpen']);
...
EZModal.propTypes = {
  ...
  reOpen: _propTypes2.default.bool,
